            ...
            <nav class="navbar navbar-expand  flex-md-column flex-row align-items-start">
                <div class="collapse navbar-collapse">
                    <ul class="flex-md-column flex-row navbar-nav w-100 justify-content-between">
                        <li class="nav-item">
                            <a href="userdashboard.php"><i class="fa fa-fw fa-home">
                                </i> Home</a>
                        </li>
                        <br>
                        <li class="nav-item">
                            <a href="#" style="text-decoration: none;"><i class="fa fa-motorcycle mr-2">
                                </i>Ride</a>
                        </li>
                        <br>
                        <li class="nav-item">
                        ...
                        <div class="card-body">
                            ...
                            <a class="nav-link" href="totalridesuser.php">
                                <h2 style="color: white; font-size: 20px; ">
                                    See Table
                                </h2><span </div> </div> </div> </div> </main> </div> </div> <?php include 'footer.php' ?> </html> <?php
                                                                                                                                    $sql = "INSERT INTO tbl_ride (source, destination, total_distance,luggage,total_fare,status,user_id,CAB_TYPE)
VALUES ('$pickup','$drop','$cdist','$luggage','$total2','1','$a','$cabtype' )";

                                                                                                                                    if (mysqli_query($conn, $sql)) {
                                                                                                                                        echo " <script> window.location.href = 'userdashboard1.php'; </script>";
                                                                                                                                    } else {
