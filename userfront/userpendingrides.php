...
<body>
  ...
  <table id="table" width="100%" class="table table-bordered display responsive">
    ...
    <tbody>
      ...
      $sql = "SELECT * FROM tbl_ride where status = 1 and user_id = $res";
      ...
      ?>
        <tr>
          ...
          <td><a style="text-decoration: none;" onclick="return confirm('Do you really want to Cancel The Ride')" href="usercancel.php?ride_id=<?php echo $s['ride_id']; ?>"> <button class="btn btn-success">CANCEL</button>
